This is a Conference Ticket Generator, built as part of HNG Task 2. It's a frontend-only project that allows users to select a conference (currently limited to one), choose multiple ticket types, and specify the number of tickets they want.

At the end of the process, users can view their full details on the ticket page. I used Context API for state management, along with other tools to enhance the experience.

<!-- more about the proj -->
:rocket: @channel Frontend Wizards, Here’s Your Stage 2 Task! :rocket:
